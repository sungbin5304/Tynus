...
import com.sungbin.fake.nusty.tynus.recorder.video.VideoEncoder;
...
public class ScreenRecorder {
    ...
    public static final String VIDEO_AVC = MIMETYPE_VIDEO_AVC;
    public static final String AUDIO_AAC = MIMETYPE_AUDIO_AAC;
